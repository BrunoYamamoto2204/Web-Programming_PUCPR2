...
<!-- menu.php -->
	...
	if(!isset($_SESSION ['login'])){                              // Não houve login ainda
		...
		header("location: $url/index.php");    // Vai para a página inicial
		exit();
    }
	?>
	<div class="w3-top"   > 
		<div class="w3-row w3-white w3-padding" >
			...
			<div class="w3-half w3-margin-top w3-wide w3-hide-medium w3-hide-small">
				<div class="w3-right"> Gerente: <?php echo $_SESSION['nome']; ?>&nbsp;
					<a href="logout.php" class="w3-btn w3-red w3-hover-red">&nbsp;Sair&nbsp;</a>
				</div >
			</div>
		</div>
